...
Note that we are assuming that the graph is undirected which makes $A$ symmetric and the weight of an edge is a non-negative measure of similarity between the two vertices. 
