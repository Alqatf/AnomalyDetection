...
The proposed algorithms offers advantages. 
First, it uses the learning algorithm that makes the simiarity function can be adapted to the particular problem. 
Second, the proposed anomaly detection algorithm is automatic and with less parametric assumption on the data. 
The experiments on the NSL-KDD 99 dataset validate the effectiveness in detecting both known and unknown type of intrusions.
